...
from multimodal_conversion import convert_text_to_audio, generate_slides_from_text
import time
import json
import threading
import re
...
def process_job(job_id, input_text, generate_audio, generate_slides):
    ...
    try:
        ...
        total_steps = sum([generate_audio, generate_slides])
        current_step = 0
...
def generate():
    ...
    threading.Thread(target=process_job, args=(job_id, input_text, generate_audio, generate_slides)).start()
